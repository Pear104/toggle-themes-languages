const data = {
    ...
    tretrau: {
        "title": " ảo thật đấy",
        "content": "Zảo chang hảo Trung gúa Xiên chai Gua zẩu PING CHILLING gúa hấn xí goàn Pính Chilling Ping sư xú yu đu dính gì bi PING Chilling, sư xú yu đu dính gì, sư xú yu đu dính gì gô zui xì hấn, sồ gi xin zài Suǒ yǐ xiàn zài shì yīn yuè shí jiān Zhǔn bèi Yī, èr, sān Liǎng gè lǐ bài yǐ hòu Sù dù yǔ jī qíng jiǔ Liǎng gè lǐ bài yǐ hòu Sù dù yǔ jī qíng jiǔ Liǎng gè lǐ bài yǐ hòu Sù dù yǔ jī qíng jiǔBù yào wàng jì, bù yào cuò gu Jì dé qù diàn yǐng yuàn kàn sù dù yǔ jī qíng jiǔ Dòng zuò fē cháng hǎo Chà bù duō yī yàng bing chilling Zài jiàn"
    },
}
...
let a = localStorage.getItem("currentLanguage")
title.innerHTML = data[a].title
paragraph.innerText = data[a].content
